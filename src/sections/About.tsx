...
export const About = () => {
  ...
  return (
    <section id="about" ref={ref} className="relative bg-bg-warm px-6 md:px-16 pt-[100px] md:pt-[140px] pb-[60px] md:pb-[80px] scroll-mt-[100px] overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] pointer-events-none opacity-[0.05]" style={{ background: "radial-gradient(circle at 20% 80%, #4ADE80, transparent 65%)" }} />
